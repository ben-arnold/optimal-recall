...
The scripts are written in R and are organized by subdirectory. 
Within each subdirectory, scripts are named to be run in sequence or there is a bash script that runs them sequentially (hopefully the organization is pretty self-explanatory).

If you have questions regarding the files in this repository please contact Ben Arnold at UC Berkeley (benarnold@berkeley.edu).
