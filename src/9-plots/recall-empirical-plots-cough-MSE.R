...
#--------------------------------------
# recall-empirical-plots-cough-MSE.R
# Ben Arnold
# 20 Oct 2011
#
...
pdf("~/dropbox/articles/wsp-recall/figures/cough/empirical-cough-MSE-RD.pdf",width=15,height=5)
...
pdf("~/dropbox/articles/wsp-recall/figures/cough/empirical-cough-MSE-RRdp.pdf",width=15,height=5)
op <- par(lwd=1.5,bty="l",cex.lab=1,mar=c(5,6,4,2)+0.1)
lo <- layout(mat=matrix(1:3,nrow=1,ncol=3))
...
pdf("~/dropbox/articles/wsp-recall/figures/cough/empirical-cough-MSE-RRpp.pdf",width=16,height=4)
...
plot(1,1,type="n",xaxt="n",yaxt="n",xlab="",ylab="",bty="n")
	legend("center",legend=c("Cough","Relative MSE\n(Day 2 = Reference)"),bty="n",cex=1.5)
