...
#--------------------------------------
# recall-empirical-plots-cough.R
# Ben Arnold
# 
...
pdf("~/dropbox/articles/wsp-recall/figures/cough/empirical-cough-bias-var-mse-PRpp.pdf",width=17,height=20)
op <- par(lwd=1.5,bty="l",cex.lab=1,mar=c(5,6,4,2)+0.1)
lo <- layout(mat=matrix(1:20,nrow=5,ncol=4),widths=rep(c(0.4,1,1,1),5))


ihpy <- seq(0,0.1,by=0.02)
impy <- seq(0,0.12,by=0.02)
indy <- seq(0,0.03,by=0.005)
pery <- seq(0,0.014,by=0.002)
seny <- seq(0,0.25,by=0.05)
