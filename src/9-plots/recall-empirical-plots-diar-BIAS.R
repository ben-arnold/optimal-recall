...
#--------------------------------------
# recall-empirical-plots-diar-BIAS.R
# Ben Arnold
# 31 Oct 2011
#
...
pdf("~/dropbox/articles/wsp-recall/figures/diar/empirical-diar-BIAS-RRpp.pdf",width=15,height=5)
...
pdf("~/dropbox/articles/wsp-recall/figures/diar/empirical-diar-BIAS-RRdp.pdf",width=15,height=5)
op <- par(lwd=1.5,bty="l",cex.lab=1,mar=c(5,6,4,2)+0.1)
...
# # pdf("~/dropbox/articles/wsp-recall/figures/diar/empirical-diar-BIAS-RDdp.pdf",width=15,height=5)
# op <- par(lwd=1.5,bty="l",cex.lab=1,mar=c(5,6,4,2)+0.1)
# lo <- layout(mat=matrix(1:3,nrow=1,ncol=3))
