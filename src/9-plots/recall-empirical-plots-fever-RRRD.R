...
#--------------------------------------
# recall-empirical-plots-fever-RRRD.R
# Ben Arnold
# 20 Oct 2011
#
...
pdf("~/dropbox/articles/wsp-recall/figures/fever/empirical-fever-RRdp.pdf",width=12,height=15)
...
RRplot(p1=himp$mdp1,p0=himp$mdp0,RR=himp$RRdp,ytics,main="HAZ < -2")
...
RRplot(p1=wimp$mdp1,p0=wimp$mdp0,RR=wimp$RRdp,ytics,main="WAZ < -2")
...
pdf("~/dropbox/articles/wsp-recall/figures/fever/empirical-fever-RRpp.pdf",width=12,height=15)
...
RRplot(p1=himp$mpp1,p0=himp$mpp0,RR=himp$RRpp,ytics,main="HAZ < -2")
...
RRplot(p1=wimp$mpp1,p0=wimp$mpp0,RR=wimp$RRpp,ytics,main="WAZ < -2")
...
pdf("~/dropbox/articles/wsp-recall/figures/fever/empirical-fever-RDdp.pdf",width=12,height=15)
lo <- layout(mat=matrix(1:20,nrow=5,ncol=4))
op <- par(mar=c(4,2,2,1)+0.1)
...
RDplot(p1=himp$mdp1,p0=himp$mdp0,RD=himp$RDdp,ytics,main="HAZ < -2")
