...
#--------------------------------------
# recall-empirical-plots-cough-BIAS.R
# Ben Arnold
# 31 Oct 2011
#
...
pdf("~/dropbox/articles/wsp-recall/figures/cough/empirical-cough-BIAS-RRpp.pdf",width=15,height=5)
...
plot(1:14,1:14,type="n",
	...
	ylab="Percent Bias in PR (%)",yaxt="n",ylim=range(ytics),
	las=1
	)
	axis(1,at=1:14)
...
pdf("~/dropbox/articles/wsp-recall/figures/cough/empirical-cough-BIAS-RRdp.pdf",width=15,height=5)
op <- par(lwd=1.5,bty="l",cex.lab=1,mar=c(5,6,4,2)+0.1)
...
# # pdf("~/dropbox/articles/wsp-recall/figures/cough/empirical-cough-BIAS-RDdp.pdf",width=15,height=5)
# op <- par(lwd=1.5,bty="l",cex.lab=1,mar=c(5,6,4,2)+0.1)
# lo <- layout(mat=matrix(1:3,nrow=1,ncol=3))
