...
#--------------------------------------
# recall-empirical-plots-fever-MSE.R
# Ben Arnold
# 20 Oct 2011
#
...
pdf("~/dropbox/articles/wsp-recall/figures/fever/empirical-fever-MSE-RD.pdf",width=15,height=5)
...
pdf("~/dropbox/articles/wsp-recall/figures/fever/empirical-fever-MSE-RRdp.pdf",width=16,height=4)
...
plot(1,1,type="n",xaxt="n",yaxt="n",xlab="",ylab="",bty="n")
	legend("center",legend=c("Fever","Relative MSE\n(Day 2 = Reference)"),bty="n",cex=1.5)
...
pdf("~/dropbox/articles/wsp-recall/figures/fever/empirical-fever-MSE-RRpp.pdf",width=16,height=4)
op <- par(lwd=1.5,bty="l",cex.lab=1,mar=c(5,6,4,2)+0.1,xpd=TRUE)
lo <- layout(mat=matrix(1:4,nrow=1,ncol=4),widths=c(0.6,1,1,1))
