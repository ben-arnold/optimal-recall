...
log using "~/dropbox/articles/wsp-recall/programs/final/7-samplesize/3-wsp-fever-sampsi-scenarios-pp.log", text replace
...
saveold "~/dropbox/articles/wsp-recall/tables/rawoutput/fever-daily-corr.dta", replace
